package ru.example.andoid_app_news.rss
...
class ArzamasRssParser : AbstractRssParser() {
    ...
    override fun readItem(parser: XmlPullParser): News {
        ...
        val formatter = DateTimeFormatter.ofPattern("dd MMM yyyy HH:mm:ss")
            .withZone(TimeZone.getDefault().toZoneId()).withLocale(
            Locale.ENGLISH
        )
        ...
        return News(
            ...
            null,
            "Arzamas",
            sourceDate.toInstant().toEpochMilli()
        )
    }
}